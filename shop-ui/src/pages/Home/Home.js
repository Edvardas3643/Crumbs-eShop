...
export default () => (
    <section className="container-wide home">
        <div className="grid">
            <NavLink to="/shopfront/muffins" className="grid-container first"
                     style={{backgroundImage: "url(" + HeroCupcakes + ")"}}>
                <p className="grid-container__description"> Muffins </p>
            </NavLink>
            <NavLink to="/shopfront/cakes" className="grid-container second"
                     style={{backgroundImage: "url(" + HeroCakes + ")"}}>
                <p className="grid-container__description"> Cakes </p>
            </NavLink>
            <NavLink to="/shopfront/kits" className="grid-container third"
